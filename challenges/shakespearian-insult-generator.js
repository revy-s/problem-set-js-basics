...
// YOUR CODE HERE
var pickAWord1 = function() {
    var insultWord = first_word[Math.floor(Math.random() * first_word.length)];
    return insultWord;
};
var pickAWord2 = function() {
    var insultWord = second_word[Math.floor(Math.random() * first_word.length)];
    return insultWord;
};
var pickAWord3 = function() {
    var insultWord = third_word[Math.floor(Math.random() * first_word.length)];
    return insultWord;
};
pickAWord1() + "  " + pickAWord2() + "  " + pickAWord3();
